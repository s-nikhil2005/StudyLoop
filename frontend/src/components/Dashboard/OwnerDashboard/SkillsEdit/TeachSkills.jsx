...
import { updateTeachingSkills } from "../../../../services/profileService";
import "./TeachSkills.css";

export default function TeachSkills({ profile, setProfile }) {

  /* ============================
     DERIVED DATA FROM PROFILE
  ============================ */

  const skills = profile?.subjectsKnown || [];
  ...
  const handleAddSkill = async () => {
    ...
    try {
      const res = await updateTeachingSkills(updatedSkills);
      ...
      console.error("Add Teaching Skill Error:", err);
    }
  };
  ...
  const handleRemoveSkill = async (index) => {
    ...
    try {
      const res = await updateTeachingSkills(updated);
      setProfile(res.profile);
    } catch (err) {
      console.error("Remove Teaching Skill Error:", err);
    }
  };
